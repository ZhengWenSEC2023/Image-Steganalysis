...
f = open('/mnt/zhengwen/new_trial/p2_single_reverse.pkl', 'rb')
...
np.save(r"/mnt/zhengwen/new_trial/test_ori_sing_output_1.npy", test_ori_ori_output[0])
np.save(r"/mnt/zhengwen/new_trial/test_ori_sing_output_2.npy", test_ori_ori_output[1])
np.save(r"/mnt/zhengwen/new_trial/test_ori_sing_output_3.npy", test_ori_ori_output[2])
np.save(r"/mnt/zhengwen/new_trial/test_ste_sing_output_1.npy", test_ste_ori_output[0])
np.save(r"/mnt/zhengwen/new_trial/test_ste_sing_output_2.npy", test_ste_ori_output[1])
np.save(r"/mnt/zhengwen/new_trial/test_ste_sing_output_3.npy", test_ste_ori_output[2])
