...
selected_cover = np.load("week_12_feature_cover_selected_px1_test.npy")   # (32000, 60, 60, 9)
selected_steg = np.load("week_12_feature_steg_selected_px1_test.npy")     # (32000, 60, 60, 9)
...
for i in range(9):  # pixelHop 0, 1: {TH1: 0.05, TH2: 0.005} finished   # features: 0 finished
    print(i)
    f = open("/mnt/zhengwen/image_steganalysis/dataset/codes/PixelHopStegoPts_5_5_2nd_3rd_layer_" + str(i) + ".pkl", 'rb')
    p2_1 = pickle.load(f)
    f.close()
    ...
    np.save("/mnt/zhengwen/image_steganalysis/dataset/codes/end_features_from_" + str(i) + "_test.npy", cur_features)
