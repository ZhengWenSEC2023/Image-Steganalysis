...
# f = open("/mnt/zhengwen/image_steganalysis/dataset/codes/PixelHopUniform_singPH_7_7.pkl", 'wb')
f = open("/mnt/zhengwen/image_steganalysis/dataset/codes/PixelHopUniform_singPH_7_7_reverse.pkl", 'wb')
# f = open("PixelHopUniform_singPH.pkl", 'wb')  # 9 * 9
pickle.dump(p2, f)
f.close()
